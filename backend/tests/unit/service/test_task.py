...
class TestTaskServiceModels:
    ...
    def test_action_update_task_data_creation(self):
        ...
        update_data = UpdateData(task=[TaskContent(id="task_1", content="Updated content")])
    ...
    def test_action_create_agent_data_creation(self):
        ...
        agent_data = {"agent_name": "TestAgent", "agent_id": "agent_123", "tools": ["search", "code"]}
    ...
    def test_action_reasoning_step_enum(self):
        """Test Action.reasoning_step enum value."""
        assert Action.reasoning_step == "reasoning_step"
...
class TestPeriodicCleanup:
    ...
    async def test_periodic_cleanup_handles_exceptions(self):
        ...
        with (
            patch("app.service.task.delete_task_lock", side_effect=Exception("Test error")),
